...
CREATE PROCEDURE [dbo].[p_classificator_update] 
...
END TRY BEGIN CATCH 
	...
	SET @ReturnNote = 'SP [dbo].[p_classificator_update] error: Entity='+@EntityName + ';IdObject=' + CAST(@IdObject as VARCHAR) + ';ColumnName=' + @ColumnName + ';CellValue=' + @CellValue 
