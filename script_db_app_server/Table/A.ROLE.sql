...
ALTER TABLE [A].[ROLE] ADD  CONSTRAINT [DF_ROLE_IdParent]  DEFAULT ((0)) FOR [IdParent]
GO

ALTER TABLE [A].[ROLE] ADD  CONSTRAINT [DF_ROLE_RankObject]  DEFAULT ((0)) FOR [RankObject]
GO

ALTER TABLE [A].[ROLE] ADD  CONSTRAINT [DF_ROLE_NameShort]  DEFAULT ('') FOR [NameShort]
GO
